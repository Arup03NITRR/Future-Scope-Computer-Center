        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@futurescope.com" className="hover:text-indigo-400 transition-colors duration-300">info@futurescope.com</a>
              </li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/9832011163" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300">
